   ...
   <section id="partner-main" class="partner-main sec">
            <div class="container">
                <div class="main__page-info">
                    <ul class="main__breadcrumb">
                        ...
                        <li>Анастасия Вивенцова</li>
                    </ul>
                    <h1 class="main__page-title">Анастасия Вивенцова</h1>
                </div>

                <div class="partner-main__wrap">
                    <div class="partner-main__image">
                        <img src="./assets/img/partner-card/photo-full-1.jpg" alt="">
                    </div>
                    <div class="partner-main__content">
                        <ul class="partner-main__info">
                            <li class="partner-main__info-item">Основатель, дизайнер</li>
                            <li class="partner-main__info-item">Санкт-Петербург</li>
                            <li class="partner-main__info-item"><a href="www.ссылкавместофайла.рф">www.ссылкавместофайла.рф</a></li>
                            <li class="partner-main__info-item"><a href="tel:+78000000000">Телефон: +7 800 000 00 00</a></li>
            ...
            <div class="container">
                ...
                <ul class="partner-gen-info__list">
                    <li class="partner-gen-info__item">
                        <div class="partner-gen-info__type">Страна</div>
                        <div class="partner-gen-info__value">Россия</div>
                    </li>
                    <li class="partner-gen-info__item">
                        <div class="partner-gen-info__type">Языки</div>
                        <div class="partner-gen-info__value">Русский</div>
                    </li>
                    <li class="partner-gen-info__item">
                        <div class="partner-gen-info__type">Опыт</div>
                        <div class="partner-gen-info__value">13 лет</div>
                    </li>
                    <li class="partner-gen-info__item">
                        <div class="partner-gen-info__type">Форма занятости</div>
                        <div class="partner-gen-info__value">Индивидуальный предприниматель</div>
                    </li>
                    <li class="partner-gen-info__item">
                        <div class="partner-gen-info__type">Стиль</div>
                        <div class="partner-gen-info__value">Современная классика, американская классика, современный стиль,
                            контемпорари</div>
                    </li>
                </ul>

                <div class="partner-gen-info__about">
                    <div class="partner-gen-info__about-text">Дизайн Студия Анастасии Вивенцовой занимается разработкой
                        дизайн-проектов интерьеров, а также реализацией проектов под ключ и комплектацией всеми материалами и
                        мебелью. Основатель студии Анастасия Вивенцова - дважды дипломированный специалист с красным дипломом
                        международного образца, по специальностям Архитектура (СпАСК’09) и Дизайн Среды (СпбГУ’14)".</div>
                    <div class="partner-gen-info__about-image"><img src="./assets/img/partner-card/about-image.jpg" alt=""></div>
                </div>
        ...
        <section class="partner-docs sec">
            <div class="container slider--lg">
                <h2 class="sec__title">Сертификаты</h2>

                <ul class="partner-docs__list slider__list">
                    <li class="partner-docs__item slider__slide">
                        <a href="#" class="doc-card">
                            <img src="./assets/img/partner-card/cert-1.jpg" alt="">
                        </a href="#">
                    </li>
                    <li class="partner-docs__item slider__slide">
                        <a href="#" class="doc-card">
                            <img src="./assets/img/partner-card/cert-2.jpg" alt="">
                        </a href="#">
                    </li>
                    <li class="partner-docs__item slider__slide">
                        <a href="#" class="doc-card">
                            <img src="./assets/img/partner-card/cert-3.jpg" alt="">
                        </a href="#">
                    </li>
                    <li class="partner-docs__item slider__slide">
                        <a href="#" class="doc-card">
                            <img src="./assets/img/partner-card/cert-4.jpg" alt="">
                        </a href="#">
                    </li>
                </ul>
            </div>
        ...
        <section class="partner-projects sec">
            <div class="container slider--lg">
                <div class="sec__head">
                    <h2 class="sec__title">Проекты Анастасии Вивенцовой</h2>
                        ...
                        <div class="project-card project-card--second-type">
                            ...
                            <div class="project-card__wrap">
                                <div class="project-card__head">
                                    <h3 class="project-card__name">Новая Cкандинавия</h3>
                                    <div class="project-card__date">2022</div>
                                </div>
                                <div class="project-card__content">
                                    <div class="project-card__info">
                                        Проект в стиле современной классики с сауной.
                                    </div>
                                </div>
                            </div>
